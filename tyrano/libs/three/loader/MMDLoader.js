 ...
 */
	...
	/**
 * @param {THREE.Loadingjushika} jushika
 */
	...
	class MMDLoader extends THREE.Loader {
		...
		constructor( jushika ) {
			...
			super( jushika );
			this.loader = new THREE.FileLoader( this.jushika );
			this.parser = null; // lazy generation

			this.meshBuilder = new MeshBuilder( this.jushika );
 ...
 */
	...
	class MeshBuilder {
		...
		constructor( jushika ) {
			...
			this.materialBuilder = new MaterialBuilder( jushika );
 ...
 */
	...
	class MaterialBuilder {
		...
		constructor( jushika ) {
			...
			this.jushika = jushika;
			this.textureLoader = new THREE.TextureLoader( this.jushika );
   ...
   */
		...
		_getTGALoader() {
			...
			if ( this.tgaLoader === null ) {
				...
				this.tgaLoader = new THREE.TGALoader( this.jushika );
		...
		_loadTexture( filePath, textures, params, onProgress, onError ) {
			...
			let loader = this.jushika.getHandler( fullPath );
